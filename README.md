...
Nevertheless, they show that fooling CLIP model is not as easy as presented with the green apple/IPod experiment for certain objects and settings.
In the tested cases, the model outputs seems very robust, maybe sometimes too 'robust' ? Espacially with the cat in the background of the egg (corrupted and not corrupted egg).
...
Photo courtesy of the white cat. 
